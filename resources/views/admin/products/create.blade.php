...
@section('title', 'ThÃªm Sáº£n Pháº©m Ná»™i Tháº¥t')
@section('page_title', 'ThÃªm Sáº£n Pháº©m Má»›i')
    ...
    <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div>
                ...
                <input type="number" name="base_price" value="{{ old('base_price', old('price')) }}" required min="0" class="w-full text-sm border rounded-lg p-2.5 outline-none focus:ring-1 focus:ring-amber-700">
            ...
            <div>
                ...
                <input type="text" value="Quáº£n lÃ½ bÃªn dÆ°á»›i" disabled class="w-full text-sm border rounded-lg p-2.5 bg-gray-50 text-gray-500">
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div>
                ...
                <input type="text" name="material" value="{{ old('material') }}" placeholder="VD: Gá»— sá»“i Nga, Da bÃ² Ã..." class="w-full text-sm border rounded-lg p-2.5 outline-none focus:ring-1 focus:ring-amber-700">
            </div>
            ...
            <div>
                ...
                <input type="text" name="color" value="{{ old('color') }}" placeholder="VD: NÃ¢u háº¡t dáº», Tráº¯ng vÃ¢n mÃ¢y" class="w-full text-sm border rounded-lg p-2.5 outline-none focus:ring-1 focus:ring-amber-700">
            </div>
        </div>
        ...
        <div class="border rounded-xl p-4 bg-amber-50/40 border-amber-100" data-variant-section>
            <div class="flex items-center justify-between mb-3">
                <div>
                    ...
                    <p class="text-xs text-gray-500">Má»—i dÃ²ng = 1 tá»• há»£p size + mÃ u gá»—, cÃ³ giÃ¡ vÃ  tá»“n kho riÃªng. Äá»ƒ trá»‘ng náº¿u sáº£n pháº©m chá»‰ cÃ³ 1 máº«u.</p>
                </div>
            ...
            <div class="space-y-3" data-variant-list data-existing="[]">
        ...
        <div>
            <label class="block text-xs font-bold uppercase text-gray-700 mb-1">áº¢nh sáº£n pháº©m (CÃ³ thá»ƒ chá»n nhiá»u áº£nh)</label>
...
(function () {
    ...
    let seed = list.querySelectorAll('[data-variant-row]').length;
