...
@section('title', 'Chỉnh sửa bài viết | Admin Mộc An')
...
<div class="max-w-4xl mx-auto rounded-3xl border border-ui-border bg-surface p-6 sm:p-10 shadow-xs">
    <div class="border-b border-ui-border pb-4 mb-6">
        <h1 class="text-lg font-bold font-display text-heading">Chỉnh sửa bài viết #{{ $post->id }}</h1>
        <p class="text-xs text-muted mt-0.5">Cập nhật nội dung, tiêu đề hoặc hình ảnh đại diện.</p>
    </div>
    ...
    <form method="POST" action="{{ route('admin.posts.update', $post) }}" class="space-y-5">
        ...
        <div class="flex items-center gap-2 pt-2">
            ...
            >
            <label for="is_published" class="text-xs font-medium text-heading">Xuất bản bài viết</label>
        </div>
