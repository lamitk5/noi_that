        ...
        <aside class="w-64 shrink-0 border-r border-ui-border bg-surface flex flex-col justify-between hidden md:flex">
            <div>
                ...
                <nav class="p-4 space-y-1.5 text-xs font-semibold" aria-label="Menu quản trị">
                    ...
                    <div class="pt-4 pb-1 px-3.5 text-[10px] font-bold uppercase tracking-widest text-muted">Hệ thống & Giao diện</div>

                    <a
                        href="{{ route('admin.ai.index') }}"
                        class="flex items-center gap-3 px-3.5 py-2.5 rounded-xl transition {{ request()->routeIs('admin.ai.*') ? 'bg-primary text-primary-foreground shadow-xs' : 'text-body hover:bg-surface-alt hover:text-heading' }}"
                    >
                    ...
                    <a
                        ...
                        class="flex items-center gap-3 px-3.5 py-2.5 rounded-xl transition {{ request()->routeIs('admin.appearance.*') ? 'bg-primary text-primary-foreground shadow-xs' : 'text-body hover:bg-surface-alt hover:text-heading' }}"
                    >
